...
window.onload = () => {
  ...
  const assets = {
    charModelAsset: new pc.Asset("model_purus_girl", "model", {
      url: "../../assets/models/model_purus_girl.glb",
    }),
    charTextureAsset: new pc.Asset("tex_purus_girl", "texture", {
      url: "../../assets/textures/tex_purus_girl.jpg",
    }),
    charIdleAnimationAsset: new pc.Asset("anim_purus_girl_idle", "animation", {
      url: "../../assets/animations/anim_purus_girl_idle.glb",
    }),
    charRunAnimationAsset: new pc.Asset("anim_purus_girl_run", "animation", {
      url: "../../assets/animations/anim_purus_girl_run.glb",
    }),
  };
  ...
  assetListLoader.load(() => {
    ...
    const material = characterEntity.model?.meshInstances[0]
    ...
    app.on("update", (dt) => {
      ...
      const moved =
        keyboard.isPressed(pc.KEY_W) ||
        keyboard.isPressed(pc.KEY_S) ||
        keyboard.isPressed(pc.KEY_A) ||
        keyboard.isPressed(pc.KEY_D);
      if (moved && currentAnim === assets.charIdleAnimationAsset.name) {
        ...
        characterEntity.animation?.play(
          assets.charIdleAnimationAsset.name,
          0.1
        );
